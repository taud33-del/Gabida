...
describe('collecterInfluencesCriteres', () => {
...
describe('collecterInfluencesSouvenirs', () => {
...
describe('collecterInfluencesAxiomes', () => {
...
describe('computeInfluences (integration)', () => {
  const fichesMock = {
