...
`SCENE_ET_PARENT` unit la sous-scène et la présence effective de son parent :
les participants d'une sous-scène sœur active en sont exclus, tandis que ceux
d'une sous-scène sœur suspendue redeviennent effectivement présents dans le
parent. `DESCENDANTS` unit une
